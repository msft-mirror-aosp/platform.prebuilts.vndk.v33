...
namespace hardware {
namespace drm {
const char* Uuid::descriptor = "android.hardware.drm.Uuid";

binder_status_t Uuid::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Uuid::writeToParcel(AParcel* _aidl_parcel) const {
