...
namespace hardware {
namespace identity {
static binder_status_t _aidl_android_hardware_identity_IIdentityCredentialStore_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*createCredential*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_docType);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_testCredential);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*getCredential*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_cipherSuite);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 3 /*createPresentationSession*/): {
      ::aidl::android::hardware::identity::CipherSuite in_cipherSuite;
      std::shared_ptr<::aidl::android::hardware::identity::IPresentationSession> _aidl_return;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_cipherSuite);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->createPresentationSession(in_cipherSuite, &_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*getRemotelyProvisionedComponent*/): {
      std::shared_ptr<::aidl::android::hardware::security::keymint::IRemotelyProvisionedComponent> _aidl_return;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->getRemotelyProvisionedComponent(&_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_identity_IIdentityCredentialStore_clazz = ::ndk::ICInterface::defineClass(IIdentityCredentialStore::descriptor, _aidl_android_hardware_identity_IIdentityCredentialStore_onTransact);
...
::ndk::ScopedAStatus BpIdentityCredentialStore::getHardwareInformation(::aidl::android::hardware::identity::HardwareInformation* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->getHardwareInformation(_aidl_return);
...
::ndk::ScopedAStatus BpIdentityCredentialStore::createCredential(const std::string& in_docType, bool in_testCredential, std::shared_ptr<::aidl::android::hardware::identity::IWritableIdentityCredential>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_docType);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_testCredential);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->createCredential(in_docType, in_testCredential, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredentialStore::getCredential(::aidl::android::hardware::identity::CipherSuite in_cipherSuite, const std::vector<uint8_t>& in_credentialData, std::shared_ptr<::aidl::android::hardware::identity::IIdentityCredential>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_cipherSuite);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->getCredential(in_cipherSuite, in_credentialData, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredentialStore::createPresentationSession(::aidl::android::hardware::identity::CipherSuite in_cipherSuite, std::shared_ptr<::aidl::android::hardware::identity::IPresentationSession>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 3 /*createPresentationSession*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->createPresentationSession(in_cipherSuite, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredentialStore::getRemotelyProvisionedComponent(std::shared_ptr<::aidl::android::hardware::security::keymint::IRemotelyProvisionedComponent>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 4 /*getRemotelyProvisionedComponent*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->getRemotelyProvisionedComponent(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredentialStore::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredentialStore::getInterfaceHash(std::string* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredentialStore::getDefaultImpl()) {
    _aidl_status = IIdentityCredentialStore::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnIdentityCredentialStore::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_identity_IIdentityCredentialStore_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IIdentityCredentialStore> IIdentityCredentialStore::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_identity_IIdentityCredentialStore_clazz)) { return nullptr; }
...
bool IIdentityCredentialStore::setDefaultImpl(const std::shared_ptr<IIdentityCredentialStore>& impl) {
...
::ndk::ScopedAStatus IIdentityCredentialStoreDefault::getCredential(::aidl::android::hardware::identity::CipherSuite /*in_cipherSuite*/, const std::vector<uint8_t>& /*in_credentialData*/, std::shared_ptr<::aidl::android::hardware::identity::IIdentityCredential>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialStoreDefault::createPresentationSession(::aidl::android::hardware::identity::CipherSuite /*in_cipherSuite*/, std::shared_ptr<::aidl::android::hardware::identity::IPresentationSession>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialStoreDefault::getRemotelyProvisionedComponent(std::shared_ptr<::aidl::android::hardware::security::keymint::IRemotelyProvisionedComponent>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
