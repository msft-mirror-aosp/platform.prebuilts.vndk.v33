...
namespace hardware {
namespace identity {
static binder_status_t _aidl_android_hardware_identity_IWritableIdentityCredential_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*getAttestationCertificate*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_attestationApplicationId);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_attestationChallenge);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*startPersonalization*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_accessControlProfileCount);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_entryCounts);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*addAccessControlProfile*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_readerCertificate);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_userAuthenticationRequired);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_timeoutMillis);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_secureUserId);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*addEntryValue*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_content);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 5 /*finishAddingEntries*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_credentialData);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_proofOfProvisioningSignature);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 6 /*setExpectedProofOfProvisioningSize*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_expectedProofOfProvisioningSize);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 7 /*setRemotelyProvisionedAttestationKey*/): {
      std::vector<uint8_t> in_attestationKeyBlob;
      std::vector<uint8_t> in_attestationCertificate;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_attestationKeyBlob);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_attestationCertificate);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->setRemotelyProvisionedAttestationKey(in_attestationKeyBlob, in_attestationCertificate);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_identity_IWritableIdentityCredential_clazz = ::ndk::ICInterface::defineClass(IWritableIdentityCredential::descriptor, _aidl_android_hardware_identity_IWritableIdentityCredential_onTransact);
...
::ndk::ScopedAStatus BpWritableIdentityCredential::getAttestationCertificate(const std::vector<uint8_t>& in_attestationApplicationId, const std::vector<uint8_t>& in_attestationChallenge, std::vector<::aidl::android::hardware::identity::Certificate>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_attestationApplicationId);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_attestationChallenge);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpWritableIdentityCredential::startPersonalization(int32_t in_accessControlProfileCount, const std::vector<int32_t>& in_entryCounts) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_accessControlProfileCount);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_entryCounts);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpWritableIdentityCredential::addAccessControlProfile(int32_t in_id, const ::aidl::android::hardware::identity::Certificate& in_readerCertificate, bool in_userAuthenticationRequired, int64_t in_timeoutMillis, int64_t in_secureUserId, ::aidl::android::hardware::identity::SecureAccessControlProfile* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_readerCertificate);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_userAuthenticationRequired);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_timeoutMillis);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_secureUserId);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpWritableIdentityCredential::addEntryValue(const std::vector<uint8_t>& in_content, std::vector<uint8_t>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_content);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpWritableIdentityCredential::finishAddingEntries(std::vector<uint8_t>* out_credentialData, std::vector<uint8_t>* out_proofOfProvisioningSignature) {
  ...
  if (!AStatus_isOk(_aidl_status.get())) goto _aidl_status_return;
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_credentialData);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_proofOfProvisioningSignature);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpWritableIdentityCredential::setExpectedProofOfProvisioningSize(int32_t in_expectedProofOfProvisioningSize) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_expectedProofOfProvisioningSize);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpWritableIdentityCredential::setRemotelyProvisionedAttestationKey(const std::vector<uint8_t>& in_attestationKeyBlob, const std::vector<uint8_t>& in_attestationCertificate) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_attestationKeyBlob);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_attestationCertificate);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 7 /*setRemotelyProvisionedAttestationKey*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IWritableIdentityCredential::getDefaultImpl()) {
    _aidl_status = IWritableIdentityCredential::getDefaultImpl()->setRemotelyProvisionedAttestationKey(in_attestationKeyBlob, in_attestationCertificate);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnWritableIdentityCredential::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_identity_IWritableIdentityCredential_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IWritableIdentityCredential> IWritableIdentityCredential::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_identity_IWritableIdentityCredential_clazz)) { return nullptr; }
...
::ndk::ScopedAStatus IWritableIdentityCredentialDefault::setRemotelyProvisionedAttestationKey(const std::vector<uint8_t>& /*in_attestationKeyBlob*/, const std::vector<uint8_t>& /*in_attestationCertificate*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
