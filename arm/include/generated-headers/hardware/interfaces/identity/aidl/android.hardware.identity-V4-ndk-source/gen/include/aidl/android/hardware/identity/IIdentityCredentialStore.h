...
public:
  ...
  static constexpr uint32_t TRANSACTION_createPresentationSession = FIRST_CALL_TRANSACTION + 3;
  static constexpr uint32_t TRANSACTION_getRemotelyProvisionedComponent = FIRST_CALL_TRANSACTION + 4;
  ...
  virtual ::ndk::ScopedAStatus createPresentationSession(::aidl::android::hardware::identity::CipherSuite in_cipherSuite, std::shared_ptr<::aidl::android::hardware::identity::IPresentationSession>* _aidl_return) = 0;
  virtual ::ndk::ScopedAStatus getRemotelyProvisionedComponent(std::shared_ptr<::aidl::android::hardware::security::keymint::IRemotelyProvisionedComponent>* _aidl_return) = 0;
