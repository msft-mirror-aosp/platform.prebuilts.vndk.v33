...
namespace power {
namespace stats {
const char* PowerEntity::descriptor = "android.hardware.power.stats.PowerEntity";

binder_status_t PowerEntity::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &states);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t PowerEntity::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, states);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
