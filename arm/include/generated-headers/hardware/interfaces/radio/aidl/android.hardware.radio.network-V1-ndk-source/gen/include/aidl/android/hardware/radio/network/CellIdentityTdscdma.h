...
public:
  ...
  inline bool operator!=(const CellIdentityTdscdma& rhs) const {
    return std::tie(mcc, mnc, lac, cid, cpid, uarfcn, operatorNames, additionalPlmns, csgInfo) != std::tie(rhs.mcc, rhs.mnc, rhs.lac, rhs.cid, rhs.cpid, rhs.uarfcn, rhs.operatorNames, rhs.additionalPlmns, rhs.csgInfo);
  }
  inline bool operator<(const CellIdentityTdscdma& rhs) const {
    return std::tie(mcc, mnc, lac, cid, cpid, uarfcn, operatorNames, additionalPlmns, csgInfo) < std::tie(rhs.mcc, rhs.mnc, rhs.lac, rhs.cid, rhs.cpid, rhs.uarfcn, rhs.operatorNames, rhs.additionalPlmns, rhs.csgInfo);
  }
  ...
  inline std::string toString() const {
    ...
    os << ", cpid: " << ::android::internal::ToString(cpid);
