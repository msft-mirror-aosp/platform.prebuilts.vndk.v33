...
namespace security {
namespace dice {
const char* Config::descriptor = "android.hardware.security.dice.Config";

binder_status_t Config::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Config::writeToParcel(AParcel* _aidl_parcel) const {
