...
static binder_status_t _aidl_android_hardware_automotive_occupant_awareness_IOccupantAwarenessClientCallback_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*onSystemStatusChanged*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_detectionFlags);
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*onDetectionEvent*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_detections);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_automotive_occupant_awareness_IOccupantAwarenessClientCallback_clazz = ::ndk::ICInterface::defineClass(IOccupantAwarenessClientCallback::descriptor, _aidl_android_hardware_automotive_occupant_awareness_IOccupantAwarenessClientCallback_onTransact);
...
::ndk::ScopedAStatus BpOccupantAwarenessClientCallback::onSystemStatusChanged(int32_t in_detectionFlags, ::aidl::android::hardware::automotive::occupant_awareness::OccupantAwarenessStatus in_status) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_detectionFlags);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwarenessClientCallback::getDefaultImpl()) {
    _aidl_status = IOccupantAwarenessClientCallback::getDefaultImpl()->onSystemStatusChanged(in_detectionFlags, in_status);
...
::ndk::ScopedAStatus BpOccupantAwarenessClientCallback::onDetectionEvent(const ::aidl::android::hardware::automotive::occupant_awareness::OccupantDetections& in_detections) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_detections);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwarenessClientCallback::getDefaultImpl()) {
    _aidl_status = IOccupantAwarenessClientCallback::getDefaultImpl()->onDetectionEvent(in_detections);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwarenessClientCallback::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwarenessClientCallback::getDefaultImpl()) {
    _aidl_status = IOccupantAwarenessClientCallback::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwarenessClientCallback::getInterfaceHash(std::string* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwarenessClientCallback::getDefaultImpl()) {
    _aidl_status = IOccupantAwarenessClientCallback::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnOccupantAwarenessClientCallback::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_automotive_occupant_awareness_IOccupantAwarenessClientCallback_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IOccupantAwarenessClientCallback> IOccupantAwarenessClientCallback::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_automotive_occupant_awareness_IOccupantAwarenessClientCallback_clazz)) { return nullptr; }
...
bool IOccupantAwarenessClientCallback::setDefaultImpl(const std::shared_ptr<IOccupantAwarenessClientCallback>& impl) {
