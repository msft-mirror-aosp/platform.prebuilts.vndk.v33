...
public:
  ...
  static constexpr uint32_t TRANSACTION_onSystemStatusChanged = FIRST_CALL_TRANSACTION + 0;
  static constexpr uint32_t TRANSACTION_onDetectionEvent = FIRST_CALL_TRANSACTION + 1;
  ...
  static bool setDefaultImpl(const std::shared_ptr<IOccupantAwarenessClientCallback>& impl);
