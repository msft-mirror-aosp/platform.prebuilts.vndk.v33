...
namespace bluetooth {
namespace audio {
const char* BroadcastCapability::descriptor = "android.hardware.bluetooth.audio.BroadcastCapability";
...
namespace bluetooth {
namespace audio {
const char* BroadcastCapability::VendorCapabilities::descriptor = "android.hardware.bluetooth.audio.BroadcastCapability.VendorCapabilities";
...
namespace bluetooth {
namespace audio {
const char* BroadcastCapability::LeAudioCodecCapabilities::descriptor = "android.hardware.bluetooth.audio.BroadcastCapability.LeAudioCodecCapabilities";
...
binder_status_t BroadcastCapability::LeAudioCodecCapabilities::readFromParcel(const AParcel* _parcel) {
  ...
  case lc3Capabilities: {
    std::optional<std::vector<std::optional<::aidl::android::hardware::bluetooth::audio::Lc3Capabilities>>> _aidl_value;
    if ((_aidl_ret_status = ::ndk::AParcel_readNullableData(_parcel, &_aidl_value)) != STATUS_OK) return _aidl_ret_status;
    if constexpr (std::is_trivially_copyable_v<std::optional<std::vector<std::optional<::aidl::android::hardware::bluetooth::audio::Lc3Capabilities>>>>) {
  ...
  case vendorCapabillities: {
    std::optional<std::vector<std::optional<::aidl::android::hardware::bluetooth::audio::BroadcastCapability::VendorCapabilities>>> _aidl_value;
    if ((_aidl_ret_status = ::ndk::AParcel_readNullableData(_parcel, &_aidl_value)) != STATUS_OK) return _aidl_ret_status;
    if constexpr (std::is_trivially_copyable_v<std::optional<std::vector<std::optional<::aidl::android::hardware::bluetooth::audio::BroadcastCapability::VendorCapabilities>>>>) {
