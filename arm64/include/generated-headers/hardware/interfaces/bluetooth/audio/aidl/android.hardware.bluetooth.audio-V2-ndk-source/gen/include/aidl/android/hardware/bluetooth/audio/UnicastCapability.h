...
public:
  ...
  private:
    std::variant<::aidl::android::hardware::bluetooth::audio::Lc3Capabilities, ::aidl::android::hardware::bluetooth::audio::UnicastCapability::VendorCapabilities> _value;
  };
...
template <>
constexpr inline std::array<aidl::android::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag, 2> enum_values<aidl::android::hardware::bluetooth::audio::UnicastCapability::LeAudioCodecCapabilities::Tag> = {
