...
namespace hardware {
namespace drm {
const char* SharedBuffer::descriptor = "android.hardware.drm.SharedBuffer";

binder_status_t SharedBuffer::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t SharedBuffer::writeToParcel(AParcel* _aidl_parcel) const {
