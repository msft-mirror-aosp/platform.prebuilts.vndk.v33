...
namespace hardware {
namespace gnss {
static binder_status_t _aidl_android_hardware_gnss_IGnssPowerIndicationCallback_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*gnssPowerStatsCb*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_gnssPowerStats);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_gnss_IGnssPowerIndicationCallback_clazz = ::ndk::ICInterface::defineClass(IGnssPowerIndicationCallback::descriptor, _aidl_android_hardware_gnss_IGnssPowerIndicationCallback_onTransact);
...
::ndk::ScopedAStatus BpGnssPowerIndicationCallback::gnssPowerStatsCb(const ::aidl::android::hardware::gnss::GnssPowerStats& in_gnssPowerStats) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_gnssPowerStats);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnGnssPowerIndicationCallback::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_gnss_IGnssPowerIndicationCallback_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IGnssPowerIndicationCallback> IGnssPowerIndicationCallback::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_gnss_IGnssPowerIndicationCallback_clazz)) { return nullptr; }
