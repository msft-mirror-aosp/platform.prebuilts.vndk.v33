...
template <>
constexpr inline std::array<aidl::android::hardware::graphics::common::StandardMetadataType, 23> enum_values<aidl::android::hardware::graphics::common::StandardMetadataType> = {
