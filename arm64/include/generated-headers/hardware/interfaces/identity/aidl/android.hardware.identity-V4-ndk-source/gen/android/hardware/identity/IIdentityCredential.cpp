...
static binder_status_t _aidl_android_hardware_identity_IIdentityCredential_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*startRetrieval*/): {
      ...
      std::vector<uint8_t> in_itemsRequest;
      std::vector<uint8_t> in_signingKeyBlob;
      std::vector<uint8_t> in_sessionTranscript;
      std::vector<uint8_t> in_readerSignature;
      std::vector<int32_t> in_requestCounts;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_accessControlProfiles);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_authToken);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_itemsRequest);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_signingKeyBlob);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_sessionTranscript);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_readerSignature);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_requestCounts);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 5 /*startRetrieveEntryValue*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_nameSpace);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_name);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_entrySize);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_accessControlProfileIds);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 6 /*retrieveEntryValue*/): {
      std::vector<uint8_t> in_encryptedContent;
      std::vector<uint8_t> _aidl_return;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_encryptedContent);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 7 /*finishRetrieval*/): {
      std::vector<uint8_t> out_mac;
      std::vector<uint8_t> out_deviceNameSpaces;
      ...
      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_mac);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_deviceNameSpaces);
      if (_aidl_ret_status != STATUS_OK) break;

      break;
    }
    case (FIRST_CALL_TRANSACTION + 8 /*generateSigningKeyPair*/): {
      std::vector<uint8_t> out_signingKeyBlob;
      ...
      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_signingKeyBlob);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 9 /*setRequestedNamespaces*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_requestNamespaces);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 10 /*setVerificationToken*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_verificationToken);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 11 /*deleteCredentialWithChallenge*/): {
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->deleteCredentialWithChallenge(in_challenge, &_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 12 /*proveOwnership*/): {
      std::vector<uint8_t> in_challenge;
      std::vector<uint8_t> _aidl_return;
      ...
      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->proveOwnership(in_challenge, &_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 13 /*updateCredential*/): {
      std::shared_ptr<::aidl::android::hardware::identity::IWritableIdentityCredential> _aidl_return;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->updateCredential(&_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_identity_IIdentityCredential_clazz = ::ndk::ICInterface::defineClass(IIdentityCredential::descriptor, _aidl_android_hardware_identity_IIdentityCredential_onTransact);
...
::ndk::ScopedAStatus BpIdentityCredential::deleteCredential(std::vector<uint8_t>* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->deleteCredential(_aidl_return);
...
::ndk::ScopedAStatus BpIdentityCredential::createEphemeralKeyPair(std::vector<uint8_t>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->createEphemeralKeyPair(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::setReaderEphemeralPublicKey(const std::vector<uint8_t>& in_publicKey) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->setReaderEphemeralPublicKey(in_publicKey);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::createAuthChallenge(int64_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->createAuthChallenge(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::startRetrieval(const std::vector<::aidl::android::hardware::identity::SecureAccessControlProfile>& in_accessControlProfiles, const ::aidl::android::hardware::keymaster::HardwareAuthToken& in_authToken, const std::vector<uint8_t>& in_itemsRequest, const std::vector<uint8_t>& in_signingKeyBlob, const std::vector<uint8_t>& in_sessionTranscript, const std::vector<uint8_t>& in_readerSignature, const std::vector<int32_t>& in_requestCounts) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_accessControlProfiles);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_authToken);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_itemsRequest);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_signingKeyBlob);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_sessionTranscript);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_readerSignature);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_requestCounts);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->startRetrieval(in_accessControlProfiles, in_authToken, in_itemsRequest, in_signingKeyBlob, in_sessionTranscript, in_readerSignature, in_requestCounts);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::startRetrieveEntryValue(const std::string& in_nameSpace, const std::string& in_name, int32_t in_entrySize, const std::vector<int32_t>& in_accessControlProfileIds) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_nameSpace);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_name);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_entrySize);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_accessControlProfileIds);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->startRetrieveEntryValue(in_nameSpace, in_name, in_entrySize, in_accessControlProfileIds);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::retrieveEntryValue(const std::vector<uint8_t>& in_encryptedContent, std::vector<uint8_t>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_encryptedContent);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->retrieveEntryValue(in_encryptedContent, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::finishRetrieval(std::vector<uint8_t>* out_mac, std::vector<uint8_t>* out_deviceNameSpaces) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->finishRetrieval(out_mac, out_deviceNameSpaces);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (!AStatus_isOk(_aidl_status.get())) goto _aidl_status_return;
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_mac);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_deviceNameSpaces);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::generateSigningKeyPair(std::vector<uint8_t>* out_signingKeyBlob, ::aidl::android::hardware::identity::Certificate* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->generateSigningKeyPair(out_signingKeyBlob, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_signingKeyBlob);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::setRequestedNamespaces(const std::vector<::aidl::android::hardware::identity::RequestNamespace>& in_requestNamespaces) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_requestNamespaces);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->setRequestedNamespaces(in_requestNamespaces);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::setVerificationToken(const ::aidl::android::hardware::keymaster::VerificationToken& in_verificationToken) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_verificationToken);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->setVerificationToken(in_verificationToken);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::deleteCredentialWithChallenge(const std::vector<uint8_t>& in_challenge, std::vector<uint8_t>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 11 /*deleteCredentialWithChallenge*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->deleteCredentialWithChallenge(in_challenge, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::proveOwnership(const std::vector<uint8_t>& in_challenge, std::vector<uint8_t>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 12 /*proveOwnership*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->proveOwnership(in_challenge, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::updateCredential(std::shared_ptr<::aidl::android::hardware::identity::IWritableIdentityCredential>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 13 /*updateCredential*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    0
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->updateCredential(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpIdentityCredential::getInterfaceHash(std::string* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IIdentityCredential::getDefaultImpl()) {
    _aidl_status = IIdentityCredential::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnIdentityCredential::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_identity_IIdentityCredential_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IIdentityCredential> IIdentityCredential::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_identity_IIdentityCredential_clazz)) { return nullptr; }
...
bool IIdentityCredential::setDefaultImpl(const std::shared_ptr<IIdentityCredential>& impl) {
...
::ndk::ScopedAStatus IIdentityCredentialDefault::deleteCredential(std::vector<uint8_t>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialDefault::createEphemeralKeyPair(std::vector<uint8_t>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialDefault::setReaderEphemeralPublicKey(const std::vector<uint8_t>& /*in_publicKey*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
...
::ndk::ScopedAStatus IIdentityCredentialDefault::retrieveEntryValue(const std::vector<uint8_t>& /*in_encryptedContent*/, std::vector<uint8_t>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialDefault::finishRetrieval(std::vector<uint8_t>* /*out_mac*/, std::vector<uint8_t>* /*out_deviceNameSpaces*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialDefault::generateSigningKeyPair(std::vector<uint8_t>* /*out_signingKeyBlob*/, ::aidl::android::hardware::identity::Certificate* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
...
::ndk::ScopedAStatus IIdentityCredentialDefault::deleteCredentialWithChallenge(const std::vector<uint8_t>& /*in_challenge*/, std::vector<uint8_t>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialDefault::proveOwnership(const std::vector<uint8_t>& /*in_challenge*/, std::vector<uint8_t>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IIdentityCredentialDefault::updateCredential(std::shared_ptr<::aidl::android::hardware::identity::IWritableIdentityCredential>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
