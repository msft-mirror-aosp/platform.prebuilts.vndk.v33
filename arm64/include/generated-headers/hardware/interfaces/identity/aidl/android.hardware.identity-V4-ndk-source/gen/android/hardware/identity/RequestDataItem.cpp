...
namespace hardware {
namespace identity {
const char* RequestDataItem::descriptor = "android.hardware.identity.RequestDataItem";

binder_status_t RequestDataItem::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &accessControlProfileIds);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  AParcel_setDataPosition(_aidl_parcel, _aidl_start_pos + _aidl_parcelable_size);
  return _aidl_ret_status;
}
binder_status_t RequestDataItem::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, accessControlProfileIds);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
