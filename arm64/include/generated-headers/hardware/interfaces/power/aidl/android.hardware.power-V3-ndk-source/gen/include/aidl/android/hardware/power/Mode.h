...
template <>
constexpr inline std::array<aidl::android::hardware::power::Mode, 17> enum_values<aidl::android::hardware::power::Mode> = {
  ...
  aidl::android::hardware::power::Mode::GAME,
  aidl::android::hardware::power::Mode::GAME_LOADING,
};
