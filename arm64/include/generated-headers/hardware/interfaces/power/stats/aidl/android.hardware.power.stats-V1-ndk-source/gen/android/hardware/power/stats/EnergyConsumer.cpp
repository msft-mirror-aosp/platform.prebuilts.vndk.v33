...
namespace power {
namespace stats {
const char* EnergyConsumer::descriptor = "android.hardware.power.stats.EnergyConsumer";

binder_status_t EnergyConsumer::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &ordinal);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t EnergyConsumer::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, ordinal);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
