...
namespace security {
namespace dice {
const char* Signature::descriptor = "android.hardware.security.dice.Signature";

binder_status_t Signature::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Signature::writeToParcel(AParcel* _aidl_parcel) const {
