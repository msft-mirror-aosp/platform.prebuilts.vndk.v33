...
namespace security {
namespace keymint {
static binder_status_t _aidl_android_hardware_security_keymint_IKeyMintDevice_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*generateKey*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_keyParams);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 3 /*importKey*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_keyFormat);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*importWrappedKey*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_wrappedKeyData);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_wrappingKeyBlob);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_maskingKey);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_unwrappingParams);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_passwordSid);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_biometricSid);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 5 /*upgradeKey*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_keyBlobToUpgrade);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_upgradeParams);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 6 /*deleteKey*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_keyBlob);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 9 /*begin*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_purpose);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 10 /*deviceLocked*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_passwordOnly);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 12 /*convertStorageKeyToEphemeral*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_storageKeyBlob);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 13 /*getKeyCharacteristics*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_appData);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 14 /*getRootOfTrustChallenge*/): {
      std::array<uint8_t, 16> _aidl_return;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->getRootOfTrustChallenge(&_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 15 /*getRootOfTrust*/): {
      std::array<uint8_t, 16> in_challenge;
      std::vector<uint8_t> _aidl_return;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_challenge);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->getRootOfTrust(in_challenge, &_aidl_return);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 16 /*sendRootOfTrust*/): {
      std::vector<uint8_t> in_rootOfTrust;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_rootOfTrust);
      if (_aidl_ret_status != STATUS_OK) break;

      ::ndk::ScopedAStatus _aidl_status = _aidl_impl->sendRootOfTrust(in_rootOfTrust);
      _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out, _aidl_status.get());
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz = ::ndk::ICInterface::defineClass(IKeyMintDevice::descriptor, _aidl_android_hardware_security_keymint_IKeyMintDevice_onTransact);
...
::ndk::ScopedAStatus BpKeyMintDevice::generateKey(const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& in_keyParams, const std::optional<::aidl::android::hardware::security::keymint::AttestationKey>& in_attestationKey, ::aidl::android::hardware::security::keymint::KeyCreationResult* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_keyParams);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::importKey(const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& in_keyParams, ::aidl::android::hardware::security::keymint::KeyFormat in_keyFormat, const std::vector<uint8_t>& in_keyData, const std::optional<::aidl::android::hardware::security::keymint::AttestationKey>& in_attestationKey, ::aidl::android::hardware::security::keymint::KeyCreationResult* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_keyFormat);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::importWrappedKey(const std::vector<uint8_t>& in_wrappedKeyData, const std::vector<uint8_t>& in_wrappingKeyBlob, const std::vector<uint8_t>& in_maskingKey, const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& in_unwrappingParams, int64_t in_passwordSid, int64_t in_biometricSid, ::aidl::android::hardware::security::keymint::KeyCreationResult* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_wrappedKeyData);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_wrappingKeyBlob);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_maskingKey);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_unwrappingParams);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_passwordSid);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_biometricSid);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::upgradeKey(const std::vector<uint8_t>& in_keyBlobToUpgrade, const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& in_upgradeParams, std::vector<uint8_t>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_keyBlobToUpgrade);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_upgradeParams);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::deleteKey(const std::vector<uint8_t>& in_keyBlob) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_keyBlob);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::begin(::aidl::android::hardware::security::keymint::KeyPurpose in_purpose, const std::vector<uint8_t>& in_keyBlob, const std::vector<::aidl::android::hardware::security::keymint::KeyParameter>& in_params, const std::optional<::aidl::android::hardware::security::keymint::HardwareAuthToken>& in_authToken, ::aidl::android::hardware::security::keymint::BeginResult* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_purpose);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::deviceLocked(bool in_passwordOnly, const std::optional<::aidl::android::hardware::security::secureclock::TimeStampToken>& in_timestampToken) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_passwordOnly);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::convertStorageKeyToEphemeral(const std::vector<uint8_t>& in_storageKeyBlob, std::vector<uint8_t>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_storageKeyBlob);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::getKeyCharacteristics(const std::vector<uint8_t>& in_keyBlob, const std::vector<uint8_t>& in_appId, const std::vector<uint8_t>& in_appData, std::vector<::aidl::android::hardware::security::keymint::KeyCharacteristics>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_appData);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::getRootOfTrustChallenge(std::array<uint8_t, 16>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 14 /*getRootOfTrustChallenge*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    FLAG_CLEAR_BUF
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IKeyMintDevice::getDefaultImpl()) {
    _aidl_status = IKeyMintDevice::getDefaultImpl()->getRootOfTrustChallenge(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::getRootOfTrust(const std::array<uint8_t, 16>& in_challenge, std::vector<uint8_t>* _aidl_return) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 15 /*getRootOfTrust*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    FLAG_CLEAR_BUF
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IKeyMintDevice::getDefaultImpl()) {
    _aidl_status = IKeyMintDevice::getDefaultImpl()->getRootOfTrust(in_challenge, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeyMintDevice::sendRootOfTrust(const std::vector<uint8_t>& in_rootOfTrust) {
  binder_status_t _aidl_ret_status = STATUS_OK;
  ::ndk::ScopedAStatus _aidl_status;
  ::ndk::ScopedAParcel _aidl_in;
  ::ndk::ScopedAParcel _aidl_out;
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_rootOfTrust);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = AIBinder_transact(
    asBinder().get(),
    (FIRST_CALL_TRANSACTION + 16 /*sendRootOfTrust*/),
    _aidl_in.getR(),
    _aidl_out.getR(),
    FLAG_CLEAR_BUF
    #ifdef BINDER_STABILITY_SUPPORT
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IKeyMintDevice::getDefaultImpl()) {
    _aidl_status = IKeyMintDevice::getDefaultImpl()->sendRootOfTrust(in_rootOfTrust);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnKeyMintDevice::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IKeyMintDevice> IKeyMintDevice::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_security_keymint_IKeyMintDevice_clazz)) { return nullptr; }
...
::ndk::ScopedAStatus IKeyMintDeviceDefault::getRootOfTrustChallenge(std::array<uint8_t, 16>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IKeyMintDeviceDefault::getRootOfTrust(const std::array<uint8_t, 16>& /*in_challenge*/, std::vector<uint8_t>* /*_aidl_return*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
::ndk::ScopedAStatus IKeyMintDeviceDefault::sendRootOfTrust(const std::vector<uint8_t>& /*in_rootOfTrust*/) {
  ::ndk::ScopedAStatus _aidl_status;
  _aidl_status.set(AStatus_fromStatus(STATUS_UNKNOWN_TRANSACTION));
  return _aidl_status;
}
