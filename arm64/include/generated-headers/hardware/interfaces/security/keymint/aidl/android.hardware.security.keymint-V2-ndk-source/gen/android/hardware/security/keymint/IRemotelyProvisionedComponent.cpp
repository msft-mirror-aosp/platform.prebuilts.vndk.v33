...
namespace security {
namespace keymint {
static binder_status_t _aidl_android_hardware_security_keymint_IRemotelyProvisionedComponent_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 1 /*generateEcdsaP256KeyPair*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_testMode);
      if (_aidl_ret_status != STATUS_OK) break;
      ...
      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_macedPublicKey);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*generateCertificateRequest*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_keysToSign);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_endpointEncryptionCertChain);
      if (_aidl_ret_status != STATUS_OK) break;
      ...
      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_deviceInfo);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_protectedData);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_security_keymint_IRemotelyProvisionedComponent_clazz = ::ndk::ICInterface::defineClass(IRemotelyProvisionedComponent::descriptor, _aidl_android_hardware_security_keymint_IRemotelyProvisionedComponent_onTransact);
...
::ndk::ScopedAStatus BpRemotelyProvisionedComponent::generateEcdsaP256KeyPair(bool in_testMode, ::aidl::android::hardware::security::keymint::MacedPublicKey* out_macedPublicKey, std::vector<uint8_t>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_testMode);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_macedPublicKey);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpRemotelyProvisionedComponent::generateCertificateRequest(bool in_testMode, const std::vector<::aidl::android::hardware::security::keymint::MacedPublicKey>& in_keysToSign, const std::vector<uint8_t>& in_endpointEncryptionCertChain, const std::vector<uint8_t>& in_challenge, ::aidl::android::hardware::security::keymint::DeviceInfo* out_deviceInfo, ::aidl::android::hardware::security::keymint::ProtectedData* out_protectedData, std::vector<uint8_t>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_keysToSign);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_endpointEncryptionCertChain);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_deviceInfo);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_protectedData);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnRemotelyProvisionedComponent::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_security_keymint_IRemotelyProvisionedComponent_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IRemotelyProvisionedComponent> IRemotelyProvisionedComponent::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_security_keymint_IRemotelyProvisionedComponent_clazz)) { return nullptr; }
