...
const char* FreqRange::descriptor = "android.hardware.wifi.supplicant.FreqRange";

binder_status_t FreqRange::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t FreqRange::writeToParcel(AParcel* _aidl_parcel) const {
