...
const char* GsmRand::descriptor = "android.hardware.wifi.supplicant.GsmRand";

binder_status_t GsmRand::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t GsmRand::writeToParcel(AParcel* _aidl_parcel) const {
