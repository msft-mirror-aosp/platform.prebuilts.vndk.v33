...
static binder_status_t _aidl_android_hardware_automotive_occupant_awareness_IOccupantAwareness_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*getCapabilityForRole*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_occupantRole);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 3 /*getState*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_detectionCapability);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 5 /*getLatestDetection*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_out, out_detections);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_automotive_occupant_awareness_IOccupantAwareness_clazz = ::ndk::ICInterface::defineClass(IOccupantAwareness::descriptor, _aidl_android_hardware_automotive_occupant_awareness_IOccupantAwareness_onTransact);
...
::ndk::ScopedAStatus BpOccupantAwareness::startDetection(::aidl::android::hardware::automotive::occupant_awareness::OccupantAwarenessStatus* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->startDetection(_aidl_return);
...
::ndk::ScopedAStatus BpOccupantAwareness::stopDetection(::aidl::android::hardware::automotive::occupant_awareness::OccupantAwarenessStatus* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->stopDetection(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwareness::getCapabilityForRole(::aidl::android::hardware::automotive::occupant_awareness::Role in_occupantRole, int32_t* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_occupantRole);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->getCapabilityForRole(in_occupantRole, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwareness::getState(::aidl::android::hardware::automotive::occupant_awareness::Role in_occupantRole, int32_t in_detectionCapability, ::aidl::android::hardware::automotive::occupant_awareness::OccupantAwarenessStatus* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_detectionCapability);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->getState(in_occupantRole, in_detectionCapability, _aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwareness::setCallback(const std::shared_ptr<::aidl::android::hardware::automotive::occupant_awareness::IOccupantAwarenessClientCallback>& in_callback) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->setCallback(in_callback);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwareness::getLatestDetection(::aidl::android::hardware::automotive::occupant_awareness::OccupantDetections* out_detections) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->getLatestDetection(out_detections);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
  ...
  if (!AStatus_isOk(_aidl_status.get())) goto _aidl_status_return;
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_out.get(), out_detections);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwareness::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpOccupantAwareness::getInterfaceHash(std::string* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IOccupantAwareness::getDefaultImpl()) {
    _aidl_status = IOccupantAwareness::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnOccupantAwareness::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_automotive_occupant_awareness_IOccupantAwareness_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IOccupantAwareness> IOccupantAwareness::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_automotive_occupant_awareness_IOccupantAwareness_clazz)) { return nullptr; }
...
bool IOccupantAwareness::setDefaultImpl(const std::shared_ptr<IOccupantAwareness>& impl) {
