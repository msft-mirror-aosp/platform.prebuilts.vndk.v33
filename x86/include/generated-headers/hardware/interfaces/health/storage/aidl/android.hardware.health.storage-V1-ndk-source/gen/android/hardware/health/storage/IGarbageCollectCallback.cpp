...
namespace health {
namespace storage {
static binder_status_t _aidl_android_hardware_health_storage_IGarbageCollectCallback_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
...
static AIBinder_Class* _g_aidl_android_hardware_health_storage_IGarbageCollectCallback_clazz = ::ndk::ICInterface::defineClass(IGarbageCollectCallback::descriptor, _aidl_android_hardware_health_storage_IGarbageCollectCallback_onTransact);
...
::ndk::SpAIBinder BnGarbageCollectCallback::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_health_storage_IGarbageCollectCallback_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IGarbageCollectCallback> IGarbageCollectCallback::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_health_storage_IGarbageCollectCallback_clazz)) { return nullptr; }
