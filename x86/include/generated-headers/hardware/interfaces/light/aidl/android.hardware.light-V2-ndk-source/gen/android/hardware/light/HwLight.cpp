...
namespace hardware {
namespace light {
const char* HwLight::descriptor = "android.hardware.light.HwLight";

binder_status_t HwLight::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t HwLight::writeToParcel(AParcel* _aidl_parcel) const {
