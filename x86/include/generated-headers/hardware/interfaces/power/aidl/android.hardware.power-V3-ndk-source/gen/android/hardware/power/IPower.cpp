...
namespace hardware {
namespace power {
static binder_status_t _aidl_android_hardware_power_IPower_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 2 /*setBoost*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_durationMs);
      if (_aidl_ret_status != STATUS_OK) break;
    ...
    case (FIRST_CALL_TRANSACTION + 4 /*createHintSession*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_tgid);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_uid);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_threadIds);
      if (_aidl_ret_status != STATUS_OK) break;

      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_durationNanos);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_power_IPower_clazz = ::ndk::ICInterface::defineClass(IPower::descriptor, _aidl_android_hardware_power_IPower_onTransact);
...
::ndk::ScopedAStatus BpPower::setBoost(::aidl::android::hardware::power::Boost in_type, int32_t in_durationMs) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_durationMs);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpPower::createHintSession(int32_t in_tgid, int32_t in_uid, const std::vector<int32_t>& in_threadIds, int64_t in_durationNanos, std::shared_ptr<::aidl::android::hardware::power::IPowerHintSession>* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_tgid);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_uid);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_threadIds);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_durationNanos);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnPower::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_power_IPower_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IPower> IPower::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_power_IPower_clazz)) { return nullptr; }
