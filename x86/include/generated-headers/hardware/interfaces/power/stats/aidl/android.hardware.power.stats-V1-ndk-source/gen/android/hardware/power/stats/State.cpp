...
namespace power {
namespace stats {
const char* State::descriptor = "android.hardware.power.stats.State";

binder_status_t State::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t State::writeToParcel(AParcel* _aidl_parcel) const {
