...
namespace radio {
namespace sim {
const char* SimRefreshResult::descriptor = "android.hardware.radio.sim.SimRefreshResult";

binder_status_t SimRefreshResult::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readData(_aidl_parcel, &efId);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t SimRefreshResult::writeToParcel(AParcel* _aidl_parcel) const {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_parcel, efId);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
