...
::ndk::ScopedAStatus BpSecureClock::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && ISecureClock::getDefaultImpl()) {
    _aidl_status = ISecureClock::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpSecureClock::getInterfaceHash(std::string* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && ISecureClock::getDefaultImpl()) {
    _aidl_status = ISecureClock::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
std::shared_ptr<ISecureClock> ISecureClock::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_security_secureclock_ISecureClock_clazz)) { return nullptr; }
