...
namespace system {
namespace keystore2 {
const char* KeyEntryResponse::descriptor = "android.system.keystore2.KeyEntryResponse";

binder_status_t KeyEntryResponse::readFromParcel(const AParcel* _aidl_parcel) {
  ...
  _aidl_ret_status = ::ndk::AParcel_readNullableData(_aidl_parcel, &iSecurityLevel);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t KeyEntryResponse::writeToParcel(AParcel* _aidl_parcel) const {
  binder_status_t _aidl_ret_status;
  size_t _aidl_start_pos = AParcel_getDataPosition(_aidl_parcel);
  _aidl_ret_status = AParcel_writeInt32(_aidl_parcel, 0);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = ::ndk::AParcel_writeNullableData(_aidl_parcel, iSecurityLevel);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
