...
namespace audio {
namespace common {
const char* Int::descriptor = "android.media.audio.common.Int";

binder_status_t Int::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Int::writeToParcel(AParcel* _aidl_parcel) const {
