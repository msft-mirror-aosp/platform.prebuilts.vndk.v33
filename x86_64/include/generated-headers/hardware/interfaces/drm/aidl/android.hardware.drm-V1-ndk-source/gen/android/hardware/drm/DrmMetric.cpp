...
namespace hardware {
namespace drm {
const char* DrmMetric::descriptor = "android.hardware.drm.DrmMetric";

binder_status_t DrmMetric::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t DrmMetric::writeToParcel(AParcel* _aidl_parcel) const {
