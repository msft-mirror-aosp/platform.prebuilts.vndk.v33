...
namespace hardware {
namespace drm {
const char* KeyValue::descriptor = "android.hardware.drm.KeyValue";

binder_status_t KeyValue::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t KeyValue::writeToParcel(AParcel* _aidl_parcel) const {
