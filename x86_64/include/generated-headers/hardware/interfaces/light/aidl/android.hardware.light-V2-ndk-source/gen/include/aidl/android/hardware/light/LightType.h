...
template <>
constexpr inline std::array<aidl::android::hardware::light::LightType, 10> enum_values<aidl::android::hardware::light::LightType> = {
  ...
  aidl::android::hardware::light::LightType::CAMERA,
};
