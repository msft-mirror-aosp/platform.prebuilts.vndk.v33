...
namespace hardware {
namespace oemlock {
static binder_status_t _aidl_android_hardware_oemlock_IOemLock_onTransact(AIBinder* _aidl_binder, transaction_code_t _aidl_code, const AParcel* _aidl_in, AParcel* _aidl_out) {
  (void)_aidl_in;
  (void)_aidl_out;
  ...
  switch (_aidl_code) {
    ...
    case (FIRST_CALL_TRANSACTION + 3 /*setOemUnlockAllowedByCarrier*/): {
      ...
      _aidl_ret_status = ::ndk::AParcel_readData(_aidl_in, &in_signature);
      if (_aidl_ret_status != STATUS_OK) break;
...
static AIBinder_Class* _g_aidl_android_hardware_oemlock_IOemLock_clazz = ::ndk::ICInterface::defineClass(IOemLock::descriptor, _aidl_android_hardware_oemlock_IOemLock_onTransact);
...
::ndk::ScopedAStatus BpOemLock::setOemUnlockAllowedByCarrier(bool in_allowed, const std::vector<uint8_t>& in_signature, ::aidl::android::hardware::oemlock::OemLockSecureStatus* _aidl_return) {
  ...
  _aidl_ret_status = ::ndk::AParcel_writeData(_aidl_in.get(), in_signature);
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::SpAIBinder BnOemLock::createBinder() {
  AIBinder* binder = AIBinder_new(_g_aidl_android_hardware_oemlock_IOemLock_clazz, static_cast<void*>(this));
  #ifdef BINDER_STABILITY_SUPPORT
...
std::shared_ptr<IOemLock> IOemLock::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_hardware_oemlock_IOemLock_clazz)) { return nullptr; }
