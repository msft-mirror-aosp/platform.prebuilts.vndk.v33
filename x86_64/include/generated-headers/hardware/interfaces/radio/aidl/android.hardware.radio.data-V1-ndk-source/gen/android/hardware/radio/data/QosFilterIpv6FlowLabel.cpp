...
namespace radio {
namespace data {
const char* QosFilterIpv6FlowLabel::descriptor = "android.hardware.radio.data.QosFilterIpv6FlowLabel";

binder_status_t QosFilterIpv6FlowLabel::readFromParcel(const AParcel* _parcel) {
...
binder_status_t QosFilterIpv6FlowLabel::writeToParcel(AParcel* _parcel) const {
