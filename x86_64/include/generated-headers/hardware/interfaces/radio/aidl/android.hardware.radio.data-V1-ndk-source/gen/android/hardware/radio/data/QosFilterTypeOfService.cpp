...
namespace radio {
namespace data {
const char* QosFilterTypeOfService::descriptor = "android.hardware.radio.data.QosFilterTypeOfService";

binder_status_t QosFilterTypeOfService::readFromParcel(const AParcel* _parcel) {
...
binder_status_t QosFilterTypeOfService::writeToParcel(AParcel* _parcel) const {
