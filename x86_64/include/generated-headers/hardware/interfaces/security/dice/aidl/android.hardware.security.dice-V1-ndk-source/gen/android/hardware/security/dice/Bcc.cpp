...
namespace security {
namespace dice {
const char* Bcc::descriptor = "android.hardware.security.dice.Bcc";

binder_status_t Bcc::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t Bcc::writeToParcel(AParcel* _aidl_parcel) const {
