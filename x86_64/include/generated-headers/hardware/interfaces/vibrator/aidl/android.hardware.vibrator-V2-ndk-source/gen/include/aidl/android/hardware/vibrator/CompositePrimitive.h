...
template <>
constexpr inline std::array<aidl::android::hardware::vibrator::CompositePrimitive, 9> enum_values<aidl::android::hardware::vibrator::CompositePrimitive> = {
  ...
  aidl::android::hardware::vibrator::CompositePrimitive::LOW_TICK,
};
