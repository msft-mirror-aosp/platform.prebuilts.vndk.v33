...
const char* IfaceInfo::descriptor = "android.hardware.wifi.supplicant.IfaceInfo";

binder_status_t IfaceInfo::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t IfaceInfo::writeToParcel(AParcel* _aidl_parcel) const {
