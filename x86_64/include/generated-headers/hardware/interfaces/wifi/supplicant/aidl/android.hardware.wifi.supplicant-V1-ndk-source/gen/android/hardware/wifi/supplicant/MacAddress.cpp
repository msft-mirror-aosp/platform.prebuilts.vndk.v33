...
const char* MacAddress::descriptor = "android.hardware.wifi.supplicant.MacAddress";

binder_status_t MacAddress::readFromParcel(const AParcel* _aidl_parcel) {
...
binder_status_t MacAddress::writeToParcel(AParcel* _aidl_parcel) const {
