...
::ndk::ScopedAStatus BpKeystoreOperation::getInterfaceVersion(int32_t* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IKeystoreOperation::getDefaultImpl()) {
    _aidl_status = IKeystoreOperation::getDefaultImpl()->getInterfaceVersion(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
::ndk::ScopedAStatus BpKeystoreOperation::getInterfaceHash(std::string* _aidl_return) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IKeystoreOperation::getDefaultImpl()) {
    _aidl_status = IKeystoreOperation::getDefaultImpl()->getInterfaceHash(_aidl_return);
    goto _aidl_status_return;
  }
  if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
std::shared_ptr<IKeystoreOperation> IKeystoreOperation::fromBinder(const ::ndk::SpAIBinder& binder) {
  if (!AIBinder_associateClass(binder.get(), _g_aidl_android_system_keystore2_IKeystoreOperation_clazz)) { return nullptr; }
